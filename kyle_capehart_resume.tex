...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ Java, Python, Go, TypeScript, JavaScript, HTML/CSS, Apex, Lightning Web Components } \\ \vspace{3pt}
    ...
    \resumeSubheading
      {Sr. Software Engineer @ ATD}{Feb 2023 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Worked on an onboarding app built with Python to sync data between CRM and internal database}
