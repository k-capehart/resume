...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ Go, TypeScript, JavaScript, Python, Java, Apex, SQL } \\ \vspace{3pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Sr. Software Engineer @ ATD}{Feb 2023 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Technical lead for a team implementing enterprise solutions in Salesforce}
            \resumeItem{Automated CI/CD release pipeline using GitHub Actions}
            \resumeItem{Worked on onboarding app built with Python to sync data between CRM and internal services}
            \resumeItem{Developed e-commerce solutions with Java and Angular (TypeScript)}
        \resumeItemListEnd
    ...
    \resumeSubheading
      {Software Developer @ Deloitte}{July 2019 \textbf{--} Feb 2023}
        \resumeItemListStart
            ...
            \resumeItem{Created front-end components using Salesforce's Lightning framework}
            \resumeItem{Built out a weekly batch job written in Apex that generated millions of lines of data}
        \resumeItemListEnd
