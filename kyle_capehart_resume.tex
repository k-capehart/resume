  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Sr. Software Engineer @ ATD}{Feb 2023 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Technical lead for internal CRM team}
            \resumeItem{Organized meetings, met with stakeholders, documented technical architecture}
            \resumeItem{Automated sales and customer support processes using Apex}
            \resumeItem{Automated CI/CD release pipeline using GitHub Actions}
            \resumeItem{Worked on an onboarding app built with Python to sync data between a CRM and a Postgres database}
            \resumeItem{Developed e-commerce solutions in SAP with Java and Angular}
        \resumeItemListEnd
