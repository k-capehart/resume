...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Salesforce:}{ Apex, LWC, Aura, Flows, SFDX, SOQL, Sales Cloud, Service Cloud, Experience Cloud, Pardot } \\ \vspace{3pt}

        \textbf{Languages:}{ Java, Python, Go, TypeScript, JavaScript, HTML/CSS, SQL } \\ \vspace{3pt}
...
\section{Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Lead Salesforce Developer @ ATD}{Feb 2023 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Wrote custom API endpoints in Apex for external services to call}
            \resumeItem{Automated CI/CD release pipeline using GitHub Actions}
            \resumeItem{Set up code scanning automation to analyze code and flows for best practices}
            \resumeItem{Worked on an onboarding app built with Python to sync data between Salesforce and a Postgres database}
    ...
    \resumeSubheading
      {Salesforce Developer @ Deloitte}{July 2019 \textbf{--} Feb 2023}
        \resumeItemListStart
            ...
            \resumeItem{Built a weekly batch job in Apex that generated millions of lines of data and resolved long standing performance issues}
